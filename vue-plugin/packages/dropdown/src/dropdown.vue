<script>
  ...
  import ElButton from 'dx-element-ui/packages/button';
  import ElButtonGroup from 'dx-element-ui/packages/button-group';
  import { generateId } from 'dx-element-ui/src/utils/util';
