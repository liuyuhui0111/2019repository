...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'dx-element-ui/src/utils/date-util';
  import { hasClass } from 'dx-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'dx-element-ui/src/utils/util';
