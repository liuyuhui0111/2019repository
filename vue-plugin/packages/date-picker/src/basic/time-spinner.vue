...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'dx-element-ui/src/utils/date-util';
  import ElScrollbar from 'dx-element-ui/packages/scrollbar';
  import RepeatClick from 'dx-element-ui/src/directives/repeat-click';
